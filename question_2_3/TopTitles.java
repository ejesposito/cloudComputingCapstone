...
public class TopTitles extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Path tmpPath = new Path("/question_2_3/tmp");
	    ...
	    String[] data = line.split(this.delimiters);
            ...
            try {
                if (data.length == 5) {
	                ...
	                context.write(new Text(data[1] + "," + data[2] + "," + data[0]), new IntWritable(1));
                    }
                }
            } catch (Exception e) {
                return;
    ...
    public static class TopTitlesMap extends Mapper<Text, Text, Text, Text> {
	    ...
	    String newValue = data[2] + "," + String.valueOf(count);

            context.write(new Text(data[0] + "," + data[1]), new Text(newValue));
        }
